...
Tutorial.timers = {};  // holds intervals and timeouts
	...
	*/
	...
	this.moveRandomly = function (options) {
		...
		*/
		...
		var maxDistance = options.maxDistance || 1;
...
Tutorial.startAction = function (name, action, delay) {

};
Tutorial.stopAction = function (name) {

};

Tutorial.repeatAction = function (times, action, delay) {
	/**
